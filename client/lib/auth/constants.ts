...
export const ADMIN_2FA_CHALLENGE_COOKIE_NAME = "admin_2fa_challenge"
export const ADMIN_2FA_VERIFIED_COOKIE_NAME = "admin_2fa_verified"
export const ADMIN_2FA_CHALLENGE_TTL_SECONDS = 10 * 60
export const ADMIN_2FA_VERIFIED_TTL_SECONDS = 8 * 60 * 60

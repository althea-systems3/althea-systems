...
const FR_CONTACT_CONTENT: ContactToolsLocaleContent = {
  ...
  responseTime: "Délai moyen de réponse : sous 24h ouvrables",
  sectionTitle: "Parlons de votre besoin",
  sectionDescription:
    "Utilisez le formulaire pour une demande détaillée, ou démarrez une conversation en temps réel avec notre assistant.",
  contactMeLabel: "Contact Me",
  supportTopicsTitle: "Sujets fréquents",
  supportTopics: [
    "Suivi de commande et statut de livraison",
    "Assistance connexion et compte client",
    "Questions produits, disponibilités et devis",
  ...
  formSubjectPlaceholder: "Ex: Problème de livraison commande #AS-4821",
  formMessageLabel: "Message",
  formMessagePlaceholder:
    "Détaillez votre demande pour permettre à l'équipe de vous répondre rapidement.",
  ...
  formErrorHint: "Corrigez les champs signalés puis réessayez.",
  validation: {
    emailRequired: "L'adresse e-mail est obligatoire.",
    emailInvalid: "Veuillez saisir une adresse e-mail valide.",
    subjectRequired: "Le sujet est obligatoire.",
    subjectTooLong: "Le sujet est trop long (140 caractères max).",
    messageRequired: "Le message est obligatoire.",
    messageTooLong: "Le message est trop long (4000 caractères max).",
  },
  chat: {
    title: "Chatbot support",
    description:
      "Posez votre question en temps réel. Vous pouvez demander un transfert vers un agent humain.",
    ...
    sendingLabel: "Envoi...",
    welcome:
      "Bonjour, je suis l'assistant Althea. Je peux vous aider sur les questions fréquentes.",
    askEmail:
    ...
    escalateLabel: "Parler à un agent",
    escalatingLabel: "Transmission en cours...",
    escalationSuccess:
      "Votre demande a été transmise à un agent humain. Nous revenons vers vous rapidement.",
    escalationError:
      "Le transfert vers un agent a échoué. Merci de réessayer ou d'utiliser le formulaire.",
    contactFormCta: "Détaillez votre demande dans le formulaire",
    botTyping: "Le bot est en train de répondre...",
    sessionLoading: "Vérification session...",
    sessionAuthenticated: "Session connectée",
